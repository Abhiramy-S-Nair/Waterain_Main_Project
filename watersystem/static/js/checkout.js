...
//         const rawPrice = totalAmount.textContent;
...
document.addEventListener('DOMContentLoaded', function () {
    const checkoutButton = document.getElementById('rzp-button1');
    const email = document.getElementById("checkout-data").getAttribute("data-email");
    const fullName = document.getElementById("checkout-data").getAttribute("data-fullname");
    const totalAmount = parseFloat(document.getElementById("total_item_amount").textContent);
